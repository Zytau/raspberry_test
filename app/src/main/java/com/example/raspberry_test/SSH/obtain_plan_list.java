...
//            System.out.println("第二个"+st);
        ...
        /**遍历出转义后的时间*/
 /*       for (String st :  array_time) {
            System.out.println("时间集合："+st);
        }

        for (String st :  array_conditon) {
            System.out.println("状态集合："+st);
        }

   for (String st :  plan_array) {
            System.out.println("集合："+st);
        }
